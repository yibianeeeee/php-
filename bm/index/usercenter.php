...
<div style="position:absolute; top:98px;left:220px; width:1290px; height:675px;
background-color:white;z-index:1;">
    <iframe src="usercenter/usercenter.php" width="1290px"height="675px" id="iFrame"></iframe>
</div>
                ...
                <ul>
                    ...
                    <li class="lsm-sidebar-item">
                        ...
                        <ul>
                            ...
                            <li><a href="javascript:;"><span>小说</span></a></li>
                            <li><a href="javascript:;"><span>历史</span></a></li>
                        </ul>
                    </li>
                    <li class="lsm-sidebar-item">
                    ...
                    <li class="lsm-sidebar-item">
                        ...
                        <ul>
                            ...
                            <li><a class="active"><span>用户中心</span></a></li>
                        </ul>
                    </li>
