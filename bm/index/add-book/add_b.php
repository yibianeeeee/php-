...
if($row){
    if(strcmp($email,$a)==0 && strcmp($pwd,$b)==0){
    }else{
        echo "<script>alert('您无权限访问!');history.go(-1);</script>";
    }

}else{

    echo "<script>alert('您未登录!');window.location.href='../../denglu.php'</script>";
}
?>
<!DOCTYPE html>
<html>
...
<div style="position:absolute; top:98px;left:220px; width:1290px; height:675px;background-color:white;z-index:1;">
    <iframe src="addbook.php" width=1290px height=675px name="iframe"></iframe>
</div>
                ...
                <ul>
                    ...
                    <li class="lsm-sidebar-item">
                        ...
                        <ul>
                            ...
                            <li><a href="../xiaoshuo.php"><span>小说</span></a></li>
                    ...
                    <li class="lsm-sidebar-item">
                        ...
                        <ul>
                            <li><a class="active"><span>新增书籍</span></a></li>
